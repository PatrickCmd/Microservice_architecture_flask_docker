...
class TestUserService(BaseTestCase):
    ...
    def test_add_user(self):
        ...
        with self.client:
            response = self.client.post(
                "users",
                data=json.dumps({"username": "patocmd", "email": "patocmd@mail.com"}),
    ...
    def test_add_user_invalid_json_keys(self):
        ...
        with self.client:
            response = self.client.post(
                "users",
                data=json.dumps({"email": "patocmd@mail.com"}),
                content_type="application/json",
            )
            data = json.loads(response.data.decode())
            self.assertEqual(response.status_code, 400)
    ...
    def test_single_user(self):
        ...
        user = add_user("patocmd", "patocmd@mail.com")
        with self.client:
    ...
    def test_all_users(self):
        ...
        add_user("patocmd", "patocmd@mail.com")
        add_user("rhenah", "rhenah@mail.com")
        with self.client:
    ...
    def test_index_add_user(self):
        ...
        with self.client:
            response = self.client.post(
                "/",
                data=dict(username="patocmd", email="patocmd@mail.com"),
